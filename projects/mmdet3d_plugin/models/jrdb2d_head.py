...
class JRDB2DHead(BaseModule):
    def __init__(
        ...
        decoder: dict = None,
        sampler: dict = None,
        gt_cls_key: str = "gt_labels_2d",
        gt_reg_key: str = "gt_bboxes_2d",
        ...
        **kwargs,
        ...
        super(JRDB2DHead, self).__init__(init_cfg)
    ...
    def forward(
        ...
        batch_size = feature_maps[0].shape[0]   #list [ (B,89760,256), (num_img,4,2), (num_img, 4)]
        ...
        for i, op in enumerate(self.operation_order):
            if self.layers[i] is None:
                ...
                quality.append(qt)
                if len(prediction) == self.num_single_frame_decoder:    # single frame 
