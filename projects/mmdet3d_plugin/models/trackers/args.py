...
def make_parser():
    ...
    parser.add_argument("--dataset", type=str, default="dancetrack", help="kitti or bdd")
    ...
    parser.add_argument( "--det", default="./detection/xxx.json", help="path to jrdb detection result")
