...
class DeformableFeatureAggregation2D(BaseModule):
    def __init__(
        self,
        embed_dims: int = 256,
        num_groups: int = 8,
        ...
        super(DeformableFeatureAggregation2D, self).__init__()
        ...
        if use_camera_embed:
            self.camera_encoder = Sequential(
                *linear_relu_ln(embed_dims, 1, 2, 9)
            )
    ...
    def feature_sampling(
        ...
        points_2d = DeformableFeatureAggregation2D.project_points(
...
class DenseDepthNet2D(BaseModule):
    def __init__(
        self,
        embed_dims=256,
        num_depth_layers=1,
...
class AsymmetricFFN2D(BaseModule):
    def __init__(
        self,
        in_channels=None,
        pre_norm=None,
        ...
        **kwargs,
        ...
        super(AsymmetricFFN2D, self).__init__(init_cfg)
        assert num_fcs >= 2, (
