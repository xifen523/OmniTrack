...
class DanceTrackConverter(object):
    def __init__(self, data_root: str, save_root: str):
        ...
        self.dancetrack_root = os.path.join(data_root, 'MOT20_v2')
    ...
    def generate_pkl(self, type: str=None, save_root: str=None):
        ...
        if type is None:
            types = ['train', 'test']
        elif isinstance(type, str) and type in ['train', 'test']:
            types = [type]
        else:
    ...
    def handle_seq(self, folder: str, type: str) -> dict:
        ...
        for img_path in imgs:
            ...
            seq_name_id = int(seq_name.split('MOT20-')[1])
    ...
    def load_gt(self, gt_path: str) -> dict:
        ...
        with open(gt_path, 'r') as f:
            for line in f:
                ...
                frame_id, obj_id, bb_left, bb_top, bb_width, bb_height, _, _, visibility = line.split(',')
                
                if float(visibility) < 0.4:
                    continue
    ...
    def save_pkl(self, save_root: str=None):
        ...
        self._save_pkl(self.train_pkl, 'mot20_infos_train.pkl', save_root)
        self._save_pkl(self.test_pkl, 'mot20_infos_test.pkl', save_root)
        self._save_pkl(self.val_pkl, 'mot20_infos_val.pkl', save_root)
...
if __name__ == '__main__':
    ...
    save_root = f'{root}/data/MOT20v2_2d_stitched_anno_pkls'
